#ifndef TFSIM2_SIMNODE_H
#define TFSIM2_SIMNODE_H
...
public:
  ...
  /// @brief 1時刻目の正常値のセットを行う．
  /// @param[in] pat 値
  /// @note 通常は外部入力に対して行われる．
  void
  set_gval1(PackedVal pat);
...
inline
void
SimNode::set_gval1(PackedVal val)
{
  mGval1 = val;
}
