...
{
  ymuint n = mNfi;
  PackedVal new_val = mFanins[0]->gval1();
  for (ymuint i = 1; i < n; ++ i) {
    new_val &= mFanins[i]->gval1();
  }
  return new_val;
}
...
SnAnd2::_calc_gval1()
{
  PackedVal pat0 = mFanins[0]->gval1();
  PackedVal pat1 = mFanins[1]->gval1();
  return pat0 & pat1;
}
...
SnAnd3::_calc_gval1()
{
  PackedVal pat0 = mFanins[0]->gval1();
  PackedVal pat1 = mFanins[1]->gval1();
  PackedVal pat2 = mFanins[2]->gval1();
...
SnAnd4::_calc_gval1()
{
  ...
  PackedVal pat1 = mFanins[1]->gval1();
  PackedVal pat2 = mFanins[2]->gval1();
  PackedVal pat3 = mFanins[3]->gval1();
